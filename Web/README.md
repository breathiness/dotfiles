...
- F Search (F搜) - 一款新的搜索引擎

支持中文与英文搜索, 过滤广告和内容农场，支持高级搜索。目前的搜索体验还算不错。让我回忆起了多吉搜索的美好回忆。  
并且这个项目正在初创的时期，给开发者反馈的问题都会很积极地接受。对我这种批话多的人来说可太快乐了，我是非常喜欢尝试使用这种软件的，有种追更的感觉。  
长期支持方面据作者说似乎可以保证后续不会关站。之后如果涉及到盈利的话会考虑增加不影响体验的广告或者出一些付费的增值服务。

除了搜索的本体服务之外还提供了一些代码分享、GitHub加速下载之类的小功能。

项目链接：<https://fsou.cc/>

- Bing  

微软出品的通用搜索引擎。搜索结果质量略弱于谷歌和百度。但无需翻墙、没有广告。(最近有点BUG，替换成上面的搜索引擎了)  
项目链接：<https://cn.bing.com/>  

- Magi  

Magi 是由 Peak Labs 研发的基于机器学习的信息抽取和检索系统。本质上并非搜索引擎，所以搜索结果弱于大部分正规搜索引擎。(本质是玩具)  
项目链接：<https://magi.com/>  
...
- 你缺失的那门计算机课 - 适合「电脑小白」的电脑使用技巧手册

前几天在网上冲浪时发现的一份很不错的文字计算机课程。把基础的使用 Windows 方法给介绍的很详细。个人认为是挺适合推荐给家里长辈以及只接触手机的后辈阅读的。当然这个详细程度我个人认为给冲浪老油条也是可以有一定的查漏补缺的作用的。工作时同事的电脑理解，很多都挺有问题的。
...
项目链接：<https://www.criwits.top/missing/>

- ​识典古籍 - 古籍数字化平台

昨天在科技爱好者周刊发现的一个挺不错的平台。可以查找很多古籍，UI也设计的挺不错的。
北京大学和抖音公益合作的古籍数字化平台。目前可免费搜索390部经典古籍，共计3000多万字。未来三年将陆续完成一万种古籍的智能化整理工作。

项目链接：<https://www.shidianguji.com/>
...
- 📻 lofi.cafe：怀旧像素风格的 Lo-fi 音乐在线电台

怀旧像素风格的网页，配上或日常、或赛博、或复古的 GIF，意蕴十足。配合快捷键，你能够很轻易地更换频道（station）、调整音量、切换背景 GIF

Lo-fi 音乐，不同于 Hi-Fi 音乐，Lo-fi 音乐中人声和乐器的声音通常都有着失真的效果。它是一种音乐的呈现形式，涵盖了摇滚、电子、RAP 等多种音乐风格。诞生之初，设备、录制环境的限制是 Lo-fi 音乐的主要原因。发展到后来，人们开始刻意在音乐中加入这种元素

项目链接：<https://www.lofi.cafe/>

- Lofi.co - 专注实用的 Lo-fi 音乐在线电台

今天自留地推荐的又一款 Lo-fi 电台。比起之前介绍的 Lofi.cafe 因为用的不是油管源，所以可以直接播放。而且还能自定义添加雨声和城市声。可以切换白天夜晚，再加上动态壁纸。整个网页还是挺好用的。
这个网站还有 2.99 刀的付费功能。不过我都觉得挺鸡肋的，免费都已经足够使用了。

网站链接：<https://app.lofi.co/>
...
生成油库里语音的文本转语音服务。输入日文之后就能生成对应的音频，然后就能直接下载。还是挺方便的。还可以切换到 Pro 版，能增加挺多选项。但是我没搞懂这个要怎么搞。  
协议是可以非商业使用，个人爱好范围内免费（制作/分发视频，包括慢声等） 如果要将生成的音频用于商业目的（包括在 YouTube 上发布带有“广告”的视频等）， 使用许可证（用于商业内容） 则需要购买。

项目链接：<https://www.yukumo.net/>
...
可以统计该链接的图片被展示过多少次的计数器。把对应的图片链接放到需要的页面，就可以统计该页面被人打开过多少次了。我在自己 GitHub 的个人介绍页面上放了一个。目前只有我自己的浏览量。
这个项目可以布置到自己的服务器上，也可以直接使用。而且可以选择多种不同的样式，比如说啊手的、动态图片的，甚至还有几个H版本的。效果非常不错，可以体现我铁血二刺螈的身份。
...
如果说RSS是我获取感兴趣的资讯的方式。那热榜就是我获取大众关注议题的方式。
有很多主流的网站是没有提供RSS源的。就算是通过RSSHUB服务建立源也是不可行的方式。一天可以刷出来一大堆我不感兴趣的文章。但我想的是只了解最热门的就行。而刚好热榜这个网站就能完美的解决我的需求。
这个网站会收集各大资讯网站的热门排行榜。并按分类分布。只要选择对应的网站，就能看到对应网站的人都在关心什么话题。大多数时候看看标题就可以大概了解世界在发生些什么。如果某些标题吸引我直接点击就能去到源页面。这种资讯获取方式我认为是高效率的。可以不需要看一大堆我不关心的内容。
而且这个网站还有一个比较方便的地方。我每天都会看看GitHub趋势榜，但公司电脑的网络访问GitHub并不稳定。而在热榜上可以稳定看到。并且还贴心地增加了一个中文按钮。点击即可查看中文项目。比原本趋势的操作都要方便。

项目链接：<https://rebang.today/>
- Pocket
...
该网站收集了中国333个地级市的报纸电子版和电视直播网址。

项目链接：<https://laosheng.top/fly/>

- Rusty Book( 锈书 )

Rust 是最近比较火的一个语言。据说已经连续六年成为全世界最受欢迎的语言。据说学习起来难道相当之大。不过从我这种普通的使用者角度来说体验非常不错。我在使用的几个 Rust 语言的软件速度都非常快，对多平台的支持也很不错。可以说用着非常爽。
今天介绍的这个网站介绍的就是收集了很多 Rust 的项目，并且进行了中文的介绍。
...
- Numara-Calculator - 基于 Electron 的简单记事本计算器，由Math.JS提供支持
我在手机上使用的计算器是 CalcNote。实时显示结果和支持多行的特性使用起来非常舒服。再加上支持汇率转换。我生活中大部分需要计算的场景，这个计算器都能满足。于是我也想在电脑上也使用类似的工具。我之前找到的替代品是Numpad。这个工具虽然实现了 CalcNote 的功能。但是 Numpad 是一个纯 Web 端的应用。这就代表着脱离网络就没办法使用了。并且由于 Numpad 是没有开源的，我也没办法在本地部署。于是非常尴尬的情况出现了：我虽然很喜欢 Numpad，但我在需要使用计算器的时候却总是用不上 Numpad。
但最近我在逛 AUR 的时候突然发现了一个相当不错的开源替代品：Numara Calculator
Numara 第一眼看上去似乎是个 Numpad 的下位替代。同样是网页应用、颜值还更差一些。但实际使用下来 Numara 会好用很多。首先是汇率计算方面，众所周知日元前段时间暴跌了很多。到现在都还保持在156附近。Numara 上的汇率是比较接近实时。但 Numpad 上的汇率却依然是135.8，可以说很影响体验了。然后是离线使用方面。Numara 虽然有 Web 版，但是也提供了 Electron 套壳桌面版本下载。离线版本除了需要联网的汇率用不了，其他功能都可以正常使用。虽然大家都挺不喜欢 Electron 的，但有总是比没有好的。

项目链接：<https://github.com/bornova/numara-calculator>
...
万词王是是一款由清华大学自然语言处理实验室（THUNLP）发布的开源在线反向词典，使用深度学习算法，可以让用户通过描述意思来查询词语，比如输入“形容开心的词”，会返回 99 个能够形容开心的词汇。——小众软件

项目链接：<https://wantwords.net/>

- WantQuotes 据意查句 - 根据意思查询对应的句子

之前介绍过的反向词典的团队制作的另一款有趣的工具。可以根据给出的意思查询对应的名言名句。可以提升我们在表达时的文化造纸。而且在给出结果时还会有对应的出处，可以避免把名言全丢给鲁迅的尴尬场面。

项目链接：<https://wantquotes.net/>
...
- Traceparts - 免费的 3D 模型、2D 图纸和 CAD 文件

在设计一些新的结构的时候，其实经常会用到很多新的外购件。这时候以前的我都是找供应商要3D，能要到都还好。但是有时候供应商还只提供2D图纸，这时候还要自己根据图纸手动画。还是相当麻烦的。Traceparts 这个软件在大部分情况下都能很好地解决这个问题。里面3D是真的挺齐全的。就算没有原品牌的，也基本都能在里面找到类似的其他品牌的东西。  
跟其他工业相关网站不同，Traceparts 的使用体验居然还挺人性化的。可以搜索、支持切换各型号尺寸、有3D、2D预览、可以选择模型精细度、可以选择导出对应软件的格式、可以直接下载。唯一不好的是你要下载模型就必须要注册一个账号。而且里面要填的东西还挺多。  
总的来说是个体验很不错、省了我很多麻烦的网站。  

项目链接：<https://www.traceparts.cn>
...
ACGN 仓库，使用 CDNDrive 下载。

CDNDrive 可以白嫖叔叔的服务器，用着还挺不错的。缺点是没办法删除。如果上传错文件，就只能永久保存了。

项目链接：<https://github.com/apachecn/CDNDrive>
...
- GitHub 3D 贡献图 - 查看、打印和共享 GitHub 贡献的 3D 模型。

在首页输入你的 GitHub 账号，以及选择你需要导出的年份。即可生成 STL 格式的贡献图的 3D 模型。
拿到 3D 之后的处理就可以看自己的技术力了。不管是直接 3D 打印还是进行渲染都非常方便。

项目链接：<https://skyline.github.com/>

- 假如月亮只有一个像素那么大 - 一幅精准又冗长的太阳系地图

这个网站是最近我见过最有创意的作品了。因为各种影视、游戏作品、概念图等的影响，我一直以来对太阳系的比例是没有一个概念的。虽然有些图是标注了实际的距离，但面对那些数字却没什么办法想象出实际的画面大概是什么样的。
而这个网站将月球设置为一个像素点大小，然后用实际的比例将整个太阳系放在一个网页内。非常好地将很多其他作品都没有的部分“星球之间的空间”展示了出来。
我是非常推荐靠滚轮浏览的方式来看这个网站的，可以更深刻地理解到距离有多么的长。（罗技的智能滚轮真好用）而且在空间中作者还写了一些彩蛋，还是非常有趣的。而且右上角可以切换语言。有中文可以使用。

项目链接：<https://joshworth.com/dev/pixelspace/pixelspace_solarsystem.html>
