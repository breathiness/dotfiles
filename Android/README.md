...
- Breezy Weather - 基于几何天气的升级版天气软件
我之前好几年查看天气预报，都是使用几何天气。几何天气的使用体验非常完善，颜值OK，而且支持小挂件。虽然已经很久没有更新，但对我来说是不更新也能用一辈子了。但最近一段时间几何天气出现了获取不到天气的情况。不知道是不是天气服务的接口有变动。
在最近小众软件也是推荐了Breezy Weather这个基于几何天气的天气软件。试用之后发现还是熟悉的味道。外观没有大改动、功能也没有缺失。并且比起之前增加了多个天气源可供选择。而且在主页增加了湿度等展示。我是非常满意了。就我目前的试用体验来说也是一个“不需要升级”的软件
项目链接：<https://github.com/breezy-weather/breezy-weather>
